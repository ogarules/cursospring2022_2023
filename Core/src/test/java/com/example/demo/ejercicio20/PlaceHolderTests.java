...
public class PlaceHolderTests {
    ...
    public void favouriteRockBandsTest() {
        log.info("Testing favourite rockbands...");
    ...
    @SneakyThrows
    @Test
    public void txtFileResourceLoadTest() {
        ApplicationContext applicationContext = new FileSystemXmlApplicationContext();

        log.info("Loading txt resource on context...");
        ...
        ResourceLoadrUtils.loadTesxtResourceTest(resource);
