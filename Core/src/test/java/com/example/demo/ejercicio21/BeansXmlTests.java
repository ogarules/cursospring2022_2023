...
public class BeansXmlTests {
    ...
    public void resolverTest(){
        log.info("Testing spel expressions...");
        ...
        Boolean numberGuessed = spelParser.parseExpression("#magicNumber == #randomNumber").getValue(springContext, Boolean.class);

        assertTrue(numberGuessed);
    }
